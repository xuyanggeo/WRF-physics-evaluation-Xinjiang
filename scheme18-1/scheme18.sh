...
#SBATCH -J scheme18-1			#作业名称，需要自定义
#SBATCH -p scheme18-1			#队列名称
#SBATCH -N 1			#使用的总节点数
#SBATCH -n 28			#使用的总核心数
...
#SBATCH -t 8:00:00		#设置作业最大运行时间，非必须
cd /public2/home/xuyang_haozhixin/XuYang/WRFV4/XINJIANG/scheme18-1
